...
class RefCOCOMapper:
    ...
    def __init__(
        ...
        *,
        ...
        logging.getLogger(__name__).info(
            "Loading CLIP tokenizer: {}...".format("/root/autodl-fs/weights/clip-vit-large-patch14")
        )
        self.tokenizer = CLIPTokenizer.from_pretrained("/root/autodl-fs/weights/clip-vit-large-patch14")
